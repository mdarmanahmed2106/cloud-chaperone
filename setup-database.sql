-- Cloud Chaperone Database Setup Script
-- This script sets up the complete database schema for the file sharing application
...
DO $$
BEGIN
  RAISE NOTICE 'Cloud Chaperone database schema has been successfully created!';
  RAISE NOTICE 'Tables created: profiles, user_roles, files, file_shares, file_permissions, access_requests';
  RAISE NOTICE 'Functions created: has_role, has_file_permission, approve_access_request, deny_access_request';
  RAISE NOTICE 'Storage bucket created: user-files';
